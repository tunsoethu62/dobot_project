...
# Dobot positions: 0-7
dobot_positions = [
    {"name":"red1","x":282.28366, "y":36.58863},
    {"name":"red2","x":281.34490, "y":4.02974},
    {"name":"green1","x":280.39285, "y":-29.90688},
    {"name":"green2","x":244.78771, "y":36.91789},
    {"name":"blue1","x":242.74148, "y":-33.28932},
    {"name":"blue2","x":209.05445, "y":36.78453},
    {"name":"yellow1","x":210.73004, "y":0.29211},
    {"name":"yellow2","x":209.27142, "y":-33.64101}
]
...
def record_position(pos_index):
    ...
    cube_name = simpledialog.askstring("Input",f"Enter cube name for position {pos_index}:\n(red1, red2, green1, green2, blue1, blue2, yellow1, yellow2)")
    if cube_name not in centroids:
        messagebox.showwarning("Warning",f"{cube_name} not detected")
        return
    camera_points[pos_index] = centroids[cube_name]
    messagebox.showinfo("Saved",f"Position {pos_index}: Camera {centroids[cube_name]} -> Dobot {dobot_positions[pos_index]}")
...
# Tkinter GUI
root = tk.Tk()
root.title("8-Cube Calibration (2 per color)")
